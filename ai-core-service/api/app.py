"""FastAPI application for AI core service."""
...
app = FastAPI(
    title="Alfred AI Core Service",
    description="AI-powered core service for project planning and future AI features",
    version="1.0.0",
)
...
async def startup_event():
    ...
    try:
        ...
        logger.info("🚀 AI Core Service ready!")

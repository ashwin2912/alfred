...
AI-powered service for project planning and future AI features using Claude Haiku 4.5.
...
This service is designed to be the central AI hub for Alfred:
- Currently handles project planning and ClickUp publishing
- Future: Task summarization, project recommendations, team insights

See `../project_refactor_guide.md` for refactoring plan and architecture details.
